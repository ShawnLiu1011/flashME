...
<html lang="en">
    ...
    <body>
		...
		<div class="content">
			<div class="conleft">
				<div id="card" setid="<?= $setid ?>"><p></p><button class="select right"><img src="images/right.jpg"></button><button class="select left"><img src="images/wrong.jpg"></button></div>
				<div id="cards">
					<h3>The card is:</h3>
					<div id="front"></div>
					<div id="back"></div>
            ...
            <div class="conright">
				<div id="introdution">
					<p>Theme: <?=$info[0]?></p>
					<p>Introduction: <?=$info[1]?></p>
					<p>Author: <?=$info[2]?></p>
				</div>
				<button id="start_button" flag="<?= $flag ?>">START</button>
				<div id="set_box_num">
					<h3>Enter the card's initial box number:</h3>
					<input id="box_num" type="text" />
					<button class = "button" id="set_box">OK</button>
				</div>
